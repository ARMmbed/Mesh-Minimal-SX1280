...
#include "NanostackRfPhySx1280.h"
NanostackRfPhyAtmel rf_phy(SX1280_SPI_MOSI, SX1280_SPI_MISO, SX1280_SPI_SCLK, SX1280_SPI_CS,
                           SX1280_SPI_RST, SX1280_SPI_IRQ, ATMEL_I2C_SDA, ATMEL_I2C_SCL);
...
int main()
{
    ...
    printf("[ ARM MBED Enabled Device ]\n");
    #else
